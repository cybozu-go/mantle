...
func testBackupFailure() {
	It("should handle removal of MantleBackup in primary k8s cluster during a full backup",
		testMBRemovalInPrimaryDuringFull)
	It("should handle removal of MantleBackup in secondary k8s cluster during a full backup",
		testMBRemovalInSecondaryDuringFull)
	It("should handle removal of MantleBackup in primary k8s cluster during an incremental backup",
		testMBRemovalInPrimaryDuringIncremental)
	It("should handle removal of MantleBackup in secondary k8s cluster during an incremental backup",
		testMBRemovalInSecondaryDuringIncremental)
}

func testMBRemovalInPrimaryDuringFull(ctx SpecContext) {
...
func testMBRemovalInSecondaryDuringFull(ctx SpecContext) {
	namespace := util.GetUniqueName("ns-")
	pvcName := util.GetUniqueName("pvc-")
	backupName := util.GetUniqueName("mb-")
...
func testMBRemovalInPrimaryDuringIncremental(ctx SpecContext) {
	namespace := util.GetUniqueName("ns-")
	pvcName := util.GetUniqueName("pvc-")
...
func testMBRemovalInSecondaryDuringIncremental(ctx SpecContext) {
	namespace := util.GetUniqueName("ns-")
	pvcName := util.GetUniqueName("pvc-")
	backupName0 := util.GetUniqueName("mb-")
	backupName1 := util.GetUniqueName("mb-")
