...
func file_pkg_controller_proto_controller_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_controller_proto_controller_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetSynchronizingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_controller_proto_controller_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetSynchronizingResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_pkg_controller_proto_controller_proto_msgTypes[6].OneofWrappers = []interface{}{}
	type x struct{}
