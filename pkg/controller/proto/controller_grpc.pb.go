...
func (UnimplementedMantleServiceServer) CreateOrUpdatePVC(context.Context, *CreateOrUpdatePVCRequest) (*CreateOrUpdatePVCResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateOrUpdatePVC not implemented")
}
func (UnimplementedMantleServiceServer) CreateMantleBackup(context.Context, *CreateMantleBackupRequest) (*CreateMantleBackupResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateMantleBackup not implemented")
}
func (UnimplementedMantleServiceServer) ListMantleBackup(context.Context, *ListMantleBackupRequest) (*ListMantleBackupResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListMantleBackup not implemented")
}
func (UnimplementedMantleServiceServer) SetSynchronizing(context.Context, *SetSynchronizingRequest) (*SetSynchronizingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetSynchronizing not implemented")
}
...
func RegisterMantleServiceServer(s grpc.ServiceRegistrar, srv MantleServiceServer) {
	// If the following call panics, it indicates UnimplementedMantleServiceServer was
