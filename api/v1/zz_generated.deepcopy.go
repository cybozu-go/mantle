...
func (in *MantleBackupStatus) DeepCopyInto(out *MantleBackupStatus) {
	*out = *in
	...
	if in.LargestCompletedExportPartNum != nil {
		in, out := &in.LargestCompletedExportPartNum, &out.LargestCompletedExportPartNum
		*out = new(int)
		**out = **in
	}
	if in.LargestCompletedUploadPartNum != nil {
		in, out := &in.LargestCompletedUploadPartNum, &out.LargestCompletedUploadPartNum
		*out = new(int)
		**out = **in
	}
	if in.LargestCompletedImportPartNum != nil {
		in, out := &in.LargestCompletedImportPartNum, &out.LargestCompletedImportPartNum
		*out = new(int)
		**out = **in
	}
}
